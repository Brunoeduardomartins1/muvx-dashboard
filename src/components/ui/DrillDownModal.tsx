            ...
            <table className="w-full">
              ...
              <tbody>
                {purchases.map(p => (
                  ...
                  >
                    <td className="px-6 py-3.5 text-sm font-sans font-500 max-w-[130px] truncate" style={{ color: 'var(--text-primary)' }}>
                      {p.studentName ?? '—'}
                    </td>
                    <td className="px-6 py-3.5 text-sm font-sans max-w-[130px] truncate" style={{ color: 'var(--text-secondary)' }}>
                      {p.personalName ?? '—'}
                    </td>
                    <td className="px-6 py-3.5 text-sm font-sans max-w-[130px] truncate" style={{ color: 'var(--text-secondary)' }}>
                      {p.planName ?? '—'}
